  ...
  return (
    <div  className="w-11/12 mx-auto" id="speaker">
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-10  items-center py-14">
        <div className="flex flex-col items-center lg:items-start gap-1 text-center lg:text-start">
          <h1 className="text-4xl font-bold leading-[60.2px] ">Meet the Speaker</h1>
          <div className="w-full ">
          <p className=" leading-[18px] xl:text-[24px] md:text-[18px] xl:leading-[40px]  ">
          ...
          <p className=" leading-[18px] xl:text-[24px] md:text-[18px] xl:leading-[40px] lg:p-y-1 xl:py-5">
