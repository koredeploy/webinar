  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          <img
            src="https://res.cloudinary.com/doejcrfso/image/upload/v1690904379/2_Nestle-Brand-Day_FS_Slider_wgecwj.jpg"
        ...
        >
          <img
            src="https://res.cloudinary.com/doejcrfso/image/upload/v1696448237/vvyl2p9a23umimpynksu.webp"
            className="block w-full"
            alt="Camera"
          />
        </div>
        ...
        >
          <img
            src="https://res.cloudinary.com/doejcrfso/image/upload/v1696447954/j2bsdd3fphqwnnzoleuk.jpg"
            className="block w-full"
            alt="Exotic Fruits"
          />
        </div>
