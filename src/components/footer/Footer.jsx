  ...
  return (
    <div style={{maxWidth:"1600px ", margin:"auto"}} className="bg-black py-6">
      ...
      <div>
        ...
        <ul>
          <li className="text-white leading-10">Home</li>
          <li className="text-white leading-10">About Webinar</li>
          <li className="text-white leading-10">The Speaker</li>
          <li className="text-white leading-10">Watch the Video</li>
        </ul>
      </div>
      <div>
        <p className="font-semibold text-white">Contact Us</p>
        <p className="text-white leading-10">info@webinar.com</p>
        <p className="text-white leading-10">+234 8123890117</p>
        <p className="text-white leading-10">+234 9045012569</p>
      </div>
      </div>
      </div>
